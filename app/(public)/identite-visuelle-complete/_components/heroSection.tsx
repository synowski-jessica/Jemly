    ...
    return (
        <>
            <div className='flex flex-col gap-10'>
                ...
                <OfferCard title={"Offre de lancement"} subtitle={"Pour les 5 premiers projets"} oldPrice={"à partir de 600€"} newPrice={"à partir de 450€"} alert={"Plus que 4 projets à ce tarif"}/>
